     ...
     <Box
        ...
        >
          <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} aria-label="breadcrumb">
            <Typography color="text.secondary" fontSize="14px">Work Order</Typography>
        ...
        <Paper sx={{ p: 1, borderRadius: 2 }}>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} sm={6} md={1}>
              <Typography sx={{ fontWeight: 500, fontSize: 14, mb: 1 }}>Work Order Number*</Typography>
            ...
            <Grid container spacing={2} sx={{ mt: 1 }}>
              ...
              <Grid item xs={12} sm={6} md={3}>
                <FormControl fullWidth required>
                  ...
                  <Typography sx={{ fontWeight: 500, fontSize: 14, mb: 1 }}>Customer Name*</Typography>
              ...
              <Grid item xs={12} sm={6} md={2}>
                <Typography sx={{ fontWeight: 500, fontSize: 14, mb: 1 }}>Work Order Date*</Typography>
        ...
        >
          ...
          <Box mt={4} display="flex" justifyContent="space-between" flexWrap="wrap" gap={2}>
            ...
            <Box display="flex" gap={2}>
              ...
              <Button variant="outlined" onClick={() => navigate('/Work-Order-list')}  sx={{
                borderRadius: 2,
                Color: '#004085',
                textTransform: 'none',
                '&:hover': {
              ...
              <Button variant="contained" onClick={() => navigate('/Work-Order-list')}  sx={{
                borderRadius: 2,
